export * as flags from "https://deno.land/std@0.62.0/flags/mod.ts";

// fs contains unstable features just re-export under fs
import { readJson } from "https://deno.land/std@0.62.0/fs/read_json.ts";
import { walk } from "https://deno.land/std@0.62.0/fs/walk.ts";
export const fs = { readJson, walk };

export * as http from "https://deno.land/std@0.62.0/http/mod.ts";
